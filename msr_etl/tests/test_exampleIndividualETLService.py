...
from msr_etl.apps import ApiEtlConfig
from msr_etl.auth_provider import get_auth_provider
from msr_etl.services.exampleIndividualETLService import ExampleIndividualETLService
from msr_etl.sources import ExampleIndividualSource
...
class ETLServiceTestCase(TestCase):
    ...
    @patch("msr_etl.apps.ApiEtlConfig.source_batch_size", new=2)
